...
<div class="wrapper row4">
  <div id="container" class="clear"> 
    <!-- ####################################################################################################### -->
    <h2 class="title">Judul halaman</h2>
    ...
    <div id="map-canvas" style="width:400px; height:400px;" align="center"></div>
    <br><br>
    <!-- Menampilkan peta usaha yang dipilih -->
    <div id="googleMap" style="width:400px;height:380px;" align="center"></div>
